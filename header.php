...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Montserrat:ital,wght@0,100..900;1,100..900&family=Pacifico&family=Poppins:ital,wght@0,100;0,200;0,300;0,400;0,500;0,600;0,700;0,800;0,900&display=swap" rel="stylesheet">
    <style>
        * {
...
<body <?php body_class(); ?>>
    ...
    <div class="bg-[#e3252d] lg:sticky static top-0 z-50 opacity-[90%]">
        <div class="container py-4 mx-auto max-w-7xl lg:py-0">
            ...
            <div id="navbarContent" class="flex flex-col items-center justify-center pt-8 lg:hidden">
                <ul class="text-white">
                    <li>
                        <a href="<?php echo home_url('/'); ?>" class="relative">Forside</a>
                    </li>
